...
export default function ProductsSection() {
  ...
  return (
    <section className="w-full flex flex-col items-center bg-section-bg">
      <h2 className="h-[66px] flex items-center justify-center text-[40px] font-bold text-center py-3 bg-white w-full">
        Wybierz urządzenie
      </h2>
      <div className="w-[1046px] w-max-[1046px] flex flex-col items-center py-6">
        ...
        <div className="grid grid-cols-3 gap-[16px] transition-all">
